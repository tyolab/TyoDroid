...
public class ShakeDetector implements SensorEventListener {
	...
	ArrayList<ShakeDetectorListener> listeners = new ArrayList<ShakeDetectorListener>();

	public void addListener(ShakeDetectorListener listener) {
		listeners.add(listener);
	}

	protected void triggerShakeDetected() {
		for(ShakeDetectorListener listener: listeners) {
